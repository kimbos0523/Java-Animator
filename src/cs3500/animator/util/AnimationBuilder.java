...
/**
 * Interface representing an AnimationBuilder, which has all methods to build up an Animation.
 *
 * @param <Doc> the document used for building
 */
public interface AnimationBuilder<Doc> {
   ...
   * @param d1   The initial degree of the shape
   * @param d2   The final degree of the shape
   * @return This {@link AnimationBuilder}
   */
   ...
   * @param d     The degree of the shape
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addKeyframe(String name,
      int t, int x, int y, int w, int h, int r, int g, int b, int d);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> setLayer(String name, int layer);
}
