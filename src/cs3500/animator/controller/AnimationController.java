...
public interface AnimationController {
   ...
   * @param degree the wanted degree of the shape
   */
  ...
  /**
   * Set the view tick by the scroll bar movement.
   *
   * @param time the specific tick for the total animation play time
   */
  void moveAnimation(int time);

  /**
   * Set the layer for the given name shape.
   *
   * @param name  the name of the specific shape
   * @param layer the layer which user want to set for the given name shape
   */
  void setLayer(String name, int layer);

  /**
   * Delete the shapes in the given layer in the Animation.
   *
