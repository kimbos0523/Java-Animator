...
public interface AnimationOperations extends ReadOnlyAnimationModel {
  ...
  /**
   * Changes the degree of a certain shape in the Animation at a certain time.
   *
   * @param name         the name of the shape
   * @param startingTime the starting time of the animation
   * @param newDegree    new degree of the shape
   * @param endingTime   the ending time of the animation
   * @throws IllegalArgumentException if the name and times are invalid (null or empty string name,
   *                                  starting time is greater than ending time or negative)
   */
  void changeDegree(String name, int startingTime, int newDegree, int endingTime);
   ...
   * @param degree the degree of the shape that the user wants to make
  ...
  /**
   * Sets the layer of shapes in the Animation.
   *
   * @param name  the name of the shape
  ...
  /**
   * delete the given layer in the Animation.
   *
   * @param layer the layer to be deleted
   * @throws IllegalArgumentException if the given layer is not existed
   */
