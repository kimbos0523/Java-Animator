...
public abstract class AShape implements AnimationShape {
   ...
   * @param degree   The degree of the current shape
   */
  public AShape(Posn2D position, ShapeColor color, int height, int width, int degree) {
    if (position == null) {
  ...
  public String toString() {
    return position.toString() + " " + width + " "
            + height + " " + color.toString();
  }
