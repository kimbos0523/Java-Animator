...
public interface AnimationShape {
  ...
  /**
   * Gets the AnimationShape at a specific time.
   *
  ...
  /**
   * Gets the degree of the AnimationShape.
   *
   * @return the degree of the AnimationShape
   */
  int getDegree();

  /**
   * Sets the degree of the AnimationShape.
   *
   * @param degree the degree which user want to set for the specific AnimationShape
   */
  void setDegree(int degree);

  /**
   * Gets the delta degree of the AnimationShape.
   *
   * @return the delta degree of the AnimationShape
   */
  float getDeltaDegree();

  /**
   * Sets the delta degree of the AnimationShape.
   *
   * @param deltaDegree the delta degree which user want to set for the specific AnimationShape
   */
  void setDeltaDegree(float deltaDegree);
