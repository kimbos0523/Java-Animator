...
public class EllipseShape extends AShape {
   ...
   */
  public EllipseShape(Posn2D position, ShapeColor color, int height, int width, int degree) {
  ...
  public AnimationShape showShape(int time) {
    ...
    EllipseShape tEllipseShape = new EllipseShape(tPosn, tColor, tHeight, tWidth, tDegree);
    ...
    tEllipseShape.setDeltaDegree(deltaDegree);
