...
public interface ReadOnlyAnimationModel {
   ...
   *         color, and the ticks of movement. If animation does not have any shape, returns empty
   *         string, if shape doesn't have movement, return only shape type
   */
  String getAnimation();
  ...
  /**
   * Gets a copy of the map of the layer in the Animation.
   *
   * @return the layer of shapes in the Animation
   */
  TreeMap<Integer, List<String>> getLayers();
}
